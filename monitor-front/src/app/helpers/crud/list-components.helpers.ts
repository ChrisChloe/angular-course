...
export abstract class ListComponent {
    ...
    loadData(): Observable<any> {
        ...
        this.shareDataService.loadingScreen(true);

        console.log(this.filterCriteria.params);
        

        return this.resource[this.resourceFunction ? this.resourceFunction : 'query'](this.filterCriteria.params ? this.filterCriteria.params : {});
        //     (res) => {
