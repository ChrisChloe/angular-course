/**
 * Invoice Cielo Credit index controller
 */
angular
    .module('app.controllers')
    .controller('InvoiceCieloCreditLiquidateCtrl', ['$scope', '$state', '$location', 'appConfig', 'Invoice', 'toastr', '$uibModal','userUtils',
        ...
        if (userUtils.isFinancial()) {
            ...
            var init = function () {
                $scope.filterCriteria.addParam('gateway_type',1);
