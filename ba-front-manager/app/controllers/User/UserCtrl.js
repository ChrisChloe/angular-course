...
angular
    ...
    .controller('UserCtrl', ['$scope', 'appConfig', 'User', 'toastr',
        function ($scope, appConfig, User, toastr) {
            ...
            $scope.userTableActions = [
                ...
                { isSubmenu: true, isDynamic: false, title: 'Desativar', icon: 'fa-ban', btnColor: 'btn-danger', fontColor: '#fff', modalTitle: 'O usuário será ativado/desativado, tem certeza?', confirmTitle: 'Ativar/Desativar', confirmColor: 'btn-danger', confirmFunction: 'inactivate' }
            ];
