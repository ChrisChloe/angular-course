...
angular
    ...
    .controller('EmailMessageReserveFiled', ['$scope', '$state', '$location', 'appConfig', 'EmailMessage', 'toastr', '$uibModal','$interval','userUtils',
        function ($scope, $state, $location, appConfig, EmailMessage, toastr, $uibModal, $interval, userUtils) {
            ...
            if (userUtils.isEmitter() || userUtils.isManager()) {
                ...
                var init = function () {
                    ...
                    $scope.filterCriteria.addParam('email_id', 9);
                ...
                $scope.show = function (message) {
                    ...
                    var modalInstance = $uibModal.open({
                        ...
                        controller: 'EmailMessageReserveFiled',
                        size: 'lg',
                        resolve: {
                            id: message.id
                        }
