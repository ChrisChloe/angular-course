        ...
        function ($q, $rootScope, OAuthToken) {
            return {
                ...
                responseError: function (rejection) {
                    ...
                    if (401 === rejection.status && rejection.data && ("unauthenticated" === rejection.data.error || "unauthorized" === rejection.data.error || "access_denied" === rejection.data.error || "invalid_credentials" === rejection.data.error) || rejection.headers("www-authenticate") && 0 === rejection.headers("www-authenticate").indexOf("Bearer")) {
